 ...
 * Four independent dependency chains are interleaved. On x86 AES-NI the hot
 * A/B/C state remains in XMM registers and each chain prefetches its next
 * dependent scratchpad line before execution moves to the other chains.
 */
                             ...
                             uint32_t iterations, size_t aes_rounds)
{
    ...
    if (yerbas_runtime_has_aes_avx2()) {
        ...
        for (i = 0; i < iterations; ++i) {
            ...
            yerbas_cn_lane_loop_phase1_xmm(ax2, bx2, &cx2, g_yerbas_cn_4way_scratchpad2, aes_rounds);
            yerbas_cn_lane_loop_phase1_xmm(ax3, bx3, &cx3, g_yerbas_cn_4way_scratchpad3, aes_rounds);
            ...
            yerbas_cn_lane_loop_phase2_xmm(&ax2, &bx2, cx2, g_yerbas_cn_4way_scratchpad2, aes_rounds, tweak2);
            yerbas_cn_lane_loop_phase2_xmm(&ax3, &bx3, cx3, g_yerbas_cn_4way_scratchpad3, aes_rounds, tweak3);
        }
    } else
#endif
    {
